export const environment = {
  ...
  USER_API_URL: 'http://localhost:9000/api/v1/bis/users',
  CATALOG_API_URL: "http://localhost:9005/api/v1/bis/catalog",
  categoryEndpoint: 'http://localhost:9002/api/v1/bis/categories',
